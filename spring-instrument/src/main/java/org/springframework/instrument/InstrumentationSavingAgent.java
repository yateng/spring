...
public class InstrumentationSavingAgent {
     ...
     * <p>
     * Note that this agent class will typically not be available in the classpath unless the agent is actually specified on JVM startup. If you intend to do
     * conditional checking with respect to agent availability, consider using
     * {@link org.springframework.instrument.classloading.InstrumentationLoadTimeWeaver#getInstrumentation()} instead - which will work without the agent class
     * in the classpath as well.
     * 
     * @return the {@code Instrumentation} instance previously saved when
     *         the {@link #premain} method was called by the JVM; will be {@code null} if this class was not used as Java agent when this JVM was started.
