...
public abstract class AbstractBeanDefinitionReader implements EnvironmentCapable, BeanDefinitionReader {
     ...
     * <p>
     * If the passed-in bean factory does not only implement the BeanDefinitionRegistry interface but also the ResourceLoader interface, it will be used as
     * default ResourceLoader as well. This will usually be the case for {@link org.springframework.context.ApplicationContext} implementations.
     * <p>
     * If given a plain BeanDefinitionRegistry, the default ResourceLoader will be a
     * {@link org.springframework.core.io.support.PathMatchingResourcePatternResolver}.
     * <p>
     * If the the passed-in bean factory also implements {@link EnvironmentCapable} its environment will be used by this reader. Otherwise, the reader will
     * initialize and use a {@link StandardEnvironment}. All ApplicationContext implementations are EnvironmentCapable, while normal BeanFactory implementations
     * are not.
     * 
     * @param registry
     ...
     * <p>
     * Default is {@code null}, which suggests to not load bean classes eagerly but rather to just register bean definitions with class names, with the
     ...
     *            that have been resolved during the loading process. May be {@code null} to indicate that the caller is not interested in those Resource
     *            objects.
