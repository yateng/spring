...
public class PropertiesBeanDefinitionReader extends AbstractBeanDefinitionReader {
     ...
     * <p>
     * Can be used e.g. for view definition files, to define a parent with a default view class and common attributes for all views. View definitions that
     * define their own parent or carry their own class can still override this.
     * <p>
     * Strictly speaking, the rule that a default parent setting does not apply to a bean definition that carries a class is there for backwards compatibility
     * reasons. It still matches the typical use case.
     */
