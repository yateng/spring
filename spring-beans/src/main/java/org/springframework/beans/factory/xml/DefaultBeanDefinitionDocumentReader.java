 ...
 * 
 * <p>
 * The structure, elements and attribute names of the required XML document are hard-coded in this class. (Of course a transform could be run if necessary to
 * produce this format). {@code &lt;beans&gt;} doesn't need to be the root element of the XML document: This class will parse all bean definition elements in
 * the XML file, not regarding the actual root element.
 * 
 * @author Rod Johnson
...
public class DefaultBeanDefinitionDocumentReader implements BeanDefinitionDocumentReader {
    ...
    protected void processBeanDefinition(Element ele, BeanDefinitionParserDelegate delegate) {
        ...
        if (bdHolder != null) {
            ...
            // Send registration event. 说是去通知IOC容器，但是这个我看里面是空实现，不知道啥意思。日了天了
