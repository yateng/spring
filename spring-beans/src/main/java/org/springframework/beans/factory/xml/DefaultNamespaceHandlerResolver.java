...
public class DefaultNamespaceHandlerResolver implements NamespaceHandlerResolver {
     ...
     * 
     * @param classLoader
     *            the {@link ClassLoader} instance used to load mapping resources
    ...
    public NamespaceHandler resolve(String namespaceUri) {
        // 这个就是从META-INF/spring.handlers文件去取handler
        ...
        if (handlerOrClassName == null) {
            ...
            try {
                ...
                if (!NamespaceHandler.class.isAssignableFrom(handlerClass)) {
                    throw new FatalBeanException("Class [" + className + "] for namespace [" + namespaceUri + "] does not implement the ["
                            + NamespaceHandler.class.getName() + "] interface");
                }
                NamespaceHandler namespaceHandler = (NamespaceHandler) BeanUtils.instantiateClass(handlerClass);
                // 如果是自定义标签，那么这儿就开始初始化你自定义的标签。jsf和jmq，看看吧，少年
                ...
                throw new FatalBeanException("Invalid NamespaceHandler class [" + className + "] for namespace [" + namespaceUri
