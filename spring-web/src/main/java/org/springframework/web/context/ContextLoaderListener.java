 ...
 * {@link #ContextLoaderListener(WebApplicationContext)} constructor, allowing for programmatic configuration in Servlet 3.0+ environments. See
...
public class ContextLoaderListener extends ContextLoader implements ServletContextListener {
     ...
     * <p>
     * This constructor is typically used when declaring {@code ContextLoaderListener} as a {@code <listener>} within {@code web.xml}, where a no-arg
     * constructor is required.
     * <p>
     * The created application context will be registered into the ServletContext under the attribute name
     * {@link WebApplicationContext#ROOT_WEB_APPLICATION_CONTEXT_ATTRIBUTE} and the Spring application context will be closed when the {@link #contextDestroyed}
     ...
     * <p>
     * The context may or may not yet be {@linkplain org.springframework.context.ConfigurableApplicationContext#refresh() refreshed}. If it (a) is an
     * implementation of {@link ConfigurableWebApplicationContext} and (b) has <strong>not</strong> already been refreshed (the recommended approach), then the
     * following will occur:
     * <ul>
     * <li>If the given context has not already been assigned an {@linkplain org.springframework.context.ConfigurableApplicationContext#setId id}, one will be
     * assigned to it</li>
     * <li>{@code ServletContext} and {@code ServletConfig} objects will be delegated to the application context</li>
     * <li>{@link #customizeContext} will be called</li>
     * <li>Any {@link org.springframework.context.ApplicationContextInitializer ApplicationContextInitializer}s specified through the
