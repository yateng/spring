...
class ExpressionEvaluator {
    ...
    public boolean condition(String conditionExpression, Method method, EvaluationContext evalContext) {
         return (Boolean) getExpression(this.conditionCache, conditionExpression, method).getValue(evalContext, boolean.class);
    }

    public boolean unless(String unlessExpression, Method method, EvaluationContext evalContext) {
        return (Boolean)getExpression(this.unlessCache, unlessExpression, method).getValue(evalContext, boolean.class);
    }
